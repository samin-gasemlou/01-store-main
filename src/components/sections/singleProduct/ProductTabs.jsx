...
export default function ProductTabs({ product }) {
  ...
  return (
    ...
    >
      <div className="flex md:flex-wrap md:gap-3 gap-2 w-full">
...
function TabButton({ active, children, onClick }) {
  return (
    <button
      onClick={onClick}
      className={`
        md:px-6 px-2 py-2 md:py-3 md:w-[190px] w-[100px]
        rounded-t-xl md:text-sm md:text-[14px] text-[12px] sm:text-base border
        transition
        ${
          active
